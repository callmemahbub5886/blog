...
@section('content')
	...
	<!-- cover header -->
    <section class="single-cover data-bg-image" data-bg-image="{{ asset('assets') }}/images/posts/single-cover.jpg">
				...
				<div class="col-lg-8">
                    ...
                    <div class="post post-single">
						...
						<div class="post-content clearfix">
							...
							<figure class="figure">
								<img src="{{ asset('assets') }}/images/posts/post-lg-2.jpg" class="figure-img img-fluid rounded" alt="...">
							...
							<img src="{{ asset('assets') }}/images/posts/single-sm-1.jpg" class="rounded alignleft" alt="...">
