	...
	<div class="container-xl">
		<div class="post-carousel-lg">
			...
			<div class="post featured-post-xl">
				...
				<a href="blog-single.html">
					<div class="thumb rounded">
						<div class="inner data-bg-image" data-bg-image="{{ asset('assets') }}/images/posts/featured-xl-1.jpg"></div>
					</div>
				</a>
			</div>
			<!-- post -->
			<div class="post featured-post-xl">
				...
				<a href="blog-single.html">
					<div class="thumb rounded">
						<div class="inner data-bg-image" data-bg-image="{{ asset('assets') }}/images/posts/featured-xl-2.jpg"></div>
					</div>
				</a>
			</div>
		</div>
			...
			<div class="col-lg-8">
				...
				<div class="post post-classic rounded bordered">
					<div class="thumb top-rounded">
						...
						<a href="blog-single.html">
							<div class="inner">
								<img src="{{ asset('assets') }}/images/posts/post-lg-1.jpg" alt="post-title" />
							</div>
						</a>
					</div>
					<div class="details">
				...
				<div class="post post-classic rounded bordered">
					<div class="thumb top-rounded">
						...
						<a href="blog-single.html">
							<div class="inner">
								<img src="{{ asset('assets') }}/images/posts/post-lg-2.jpg" alt="post-title" />
							</div>
						</a>
					</div>
					<div class="details">
				...
				<div class="post post-classic rounded bordered">
					<div class="thumb top-rounded">
						...
						<a href="blog-single.html">
							<div class="inner">
								<img src="{{ asset('assets') }}/images/posts/post-lg-3.jpg" alt="post-title" />
							</div>
						</a>
					</div>
					<div class="details">
				...
				<div class="post post-classic rounded bordered">
					<div class="thumb top-rounded">
						...
						<a href="blog-single.html">
							<div class="inner">
								<img src="{{ asset('assets') }}/images/posts/post-lg-4.jpg" alt="post-title" />
							</div>
						</a>
					</div>
					<div class="details">
