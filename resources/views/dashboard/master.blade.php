        ...
        <div class="main-menu">
            ...
            <div data-simplebar>
                <ul class="app-menu">
                    ...
                    <li class="menu-item">
                        <a class='menu-link waves-effect waves-light' href='{{ route('admin') }}'>
                            <span class="menu-icon"><i class='bx bxs-user-pin'></i></span>
                            <span class="menu-text">Admin</span>
                        </a>
                    </li>

                    <li class="menu-item">
                        <a class='menu-link waves-effect waves-light' href='{{ route('blog') }}'>
                        ...
                        <li class="dropdown">
                            <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light"
                                ...
                                @if (Auth()->user()->profile == 'default.jpg')
                                    <img style="object-fit: contain;" src="{{ asset('dashboard/assets/images/default/default-2.png') }}" alt="user-image"
                                @else
                                    <img style="object-fit: contain;" src="{{ asset('dashboard/assets/images/profile/'.Auth()->user()->profile) }}" alt="user-image"
                                @endif
                            ...
                            <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
                                ...
                                <div class="dropdown-header noti-title">
                                    <6 class="text-overflow m-0">Welcome !</6>
                                </div>
