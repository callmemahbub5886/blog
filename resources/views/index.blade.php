				...
				<div class="post featured-post-lg">
					...
					<a href="blog-single.html">
						<div class="thumb rounded">
							<div class="inner data-bg-image" data-bg-image="{{ asset('assets') }}/images/posts/featured-lg.jpg"></div>
						</div>
					</a>
				</div>
						...
						<div class="col-sm-6">
							...
							<div class="post post-list-sm square">
								<div class="thumb rounded">
									<a href="blog-single.html">
										<div class="inner">
											<img src="{{ asset('assets') }}/images/posts/editor-sm-1.jpg" alt="post-title" />
										</div>
									</a>
								</div>
								<div class="details clearfix">
